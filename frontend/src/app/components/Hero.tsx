            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100"><b>March 28, 2026 </b> | 9:00 AM - 5:00 PM</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100"><b>Smt Jasti Bullemmai College For Women</b> Rajahmundry, Andhra Pradesh, 533107</p>
                </div>
              </div>
            </div>
